...
*/
     ...
     *
     */
    public function updateReservationJSON(Request $request, NormalizerInterface $Normalizer, $id)
    {
        $em = $this->getDoctrine()->getManager();
    ...
    /**
     * @Route("/deleteReservationJSON/{id}",name="deletecommentJSON")
     *
     *
     */
    public function deleteReservationJSON(Request $request,NormalizerInterface $Normalizer,$id){
        $em=$this->getDoctrine()->getManager();
