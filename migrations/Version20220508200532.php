 ...
 */
final class Version20220508200532 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture DROP INDEX idClient, ADD INDEX IDX_FE866410A455ACCF (idClient)');
        $this->addSql('ALTER TABLE facture DROP INDEX numReservation, ADD UNIQUE INDEX UNIQ_FE86641028087671 (numReservation)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture DROP INDEX UNIQ_FE86641028087671, ADD INDEX numReservation (numReservation)');
        ...
        $this->addSql('CREATE INDEX idClient ON facture (idClient)');
