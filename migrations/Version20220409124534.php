 ...
 */
final class Version20220409124534 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD CONSTRAINT FK_67F068BC67F0C0D4 FOREIGN KEY (idclient_id) REFERENCES utilisateur (id)');
