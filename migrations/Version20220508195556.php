 ...
 */
final class Version20220508195556 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX numReservation ON facture');
        $this->addSql('ALTER TABLE facture DROP FOREIGN KEY FK_FE866410A455ACCF');
        $this->addSql('ALTER TABLE facture CHANGE NumReservation numReservation INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture DROP FOREIGN KEY FK_FE866410A455ACCF');
        $this->addSql('ALTER TABLE facture CHANGE numReservation NumReservation INT NOT NULL');
        $this->addSql('CREATE INDEX numReservation ON facture (NumReservation)');
