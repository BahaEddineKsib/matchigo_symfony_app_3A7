...
public class ServiceReservation {
    ...
    public void AjouterReservation(Reservation res){
        ...
        String url="http://127.0.0.1:8000/reservation/addReservationJSON/new?nbrplace="+res.getNbrPlace()+ "&datedebut="+res.getDateDebut()+ "&datefin="+res.getDateFin()+"&plan="+res.getPlan()                              ;
        req.setUrl(url);
...
//                        String dateStr=formatter.format(date);
    ...
    /***********************/
        ...
        public ArrayList<Reservation> detailsReservation(){
            ArrayList<Reservation> result = new ArrayList<>();
            Reservation res=new Reservation();
            String url = "http://127.0.0.1:8000/reservation/showResMobile";
            req.setUrl(url);
...
//                            String dateString1 = formatter1.format(currentTime1);
        ...
        return  resultOk;
           ...
           public boolean modifierReservation(Reservation res,int num ){
               
         String url="http://127.0.0.1:8000/reservation/updateReservationJSON/"+num+"?nbrplace="+res.getNbrPlace()+"&datedebut="+res.getDateDebut()+"&datefin="+res.getDateFin()+"&plan="+res.getPlan()  ;
