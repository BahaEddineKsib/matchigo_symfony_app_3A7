...
public class AjouterReclamationForm extends BaseForm {
    ...
    public AjouterReclamationForm(Resources res ) {
        ...
        RadioButton liste = RadioButton.createToggle("Liste livraison", barGroup);
        ...
        TextField lang = new TextField("", "entrer lang!!");
        lang.setUIID("TextFieldBlack");
        addStringValue("lang",lang);
         TextField attitude = new TextField("", "entrer attitude!!");
        attitude.setUIID("TextFieldBlack");
        addStringValue("attitude",attitude);
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                ...
                if( price.getText().equals("")) {
                    ...
                    Delivery r=new Delivery(String.valueOf(lang.getText().toString()),String.valueOf(attitude.getText().toString() ),Integer.parseInt(price.getText().toString()));
                    System.out.println("data reclamation =="+r);
                    
                    
                    ServicesReclamtion.getInstance().ajouterDelivery(r);
    ...
    public void sendMail(Resources res) {
		...
		props.put("mail.smtps.auth", "true"); //enable authentication
            ...
            msg.setRecipients(Message.RecipientType.TO, "mootezmejdoub@gmail.com");
