...
public class ListeReclamationForm extends BaseForm{
    ...
    public ListeReclamationForm(Resources res ) {
        ...
        RadioButton liste = RadioButton.createToggle("livrer", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("Liste livraison", barGroup);
        partage.setUIID("SelectBar");
        Label arrow = new Label(res.getImage("news-tab-down-arrow.png"), "Container");
        liste.addActionListener((e) -> {
            new AjouterReclamationForm(res).show();
        ...
        ArrayList<Delivery>list = ServicesReclamtion.getInstance().affichageReclamations();
        
        for(Delivery rec : list ) {
    ...
    private void addButton(Image img,Delivery rec , Resources res) {
        ...
        Label etatTxt  = new Label("Lang : "+rec.getLang(),"NewsTopLine2");
        Label  descriptionTxt= new Label("attitude : "+rec.getAttitude(),"NewsTopLine2" );
        Label  referenceTxt= new Label("price : "+rec.getPrice(),"NewsTopLine2" );
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce reclamation ?","Annuler","Oui")) {
                ...
                //if(ServicesReclamtion.getInstance().deleteReclamation(rec.getId())) {
       ...
       //    new ModifierReclamationForm(res,rec).show();
        ...
        BoxLayout.encloseX(referenceTxt),
