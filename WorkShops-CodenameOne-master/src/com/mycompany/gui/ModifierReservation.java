...
public class ModifierReservation extends BaseForm{
    ...
    public ModifierReservation(Resources res ) {
        ...
        super.addSideMenu(res);
         ...
         int num = r.getNumReservation();
            String placeVal = String.valueOf(r.getNbrPlace());
        TextField nbrplace = new TextField(" ", "place" , 20 , TextField.NUMERIC);
        ...
        TextField plan = new TextField(r.getPlan(), "Plan", 20, TextField.ANY);
       ...
       btnModifier.addPointerPressedListener(l ->   { 
           ...
           r.setPlan(plan.getText()); 
       
       
       
       if(ServiceReservation.getInstance().modifierReservation(r,num)) { // if true
